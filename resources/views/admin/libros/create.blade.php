    ...
    <div class="container py-4">
        ...
        <form action="#" method="post">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <label class="form-label">Año de publicación original</label>
                    <input type="number" name="anio_publicacion_original" class="form-control">
                </div>

                <div class="col-md-6">
                    <label class="form-label">Género principal</label>
                    <select name="genero_principal_id" class="form-select">
